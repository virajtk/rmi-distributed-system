...
public class AddSensorForm extends JDialog {
	...
	public AddSensorForm() {
		...
		JLabel lblNewLabel = new JLabel("ID (Serial No :)");
		...
		lblNewLabel_2.setFont(new Font("Serif", Font.PLAIN, 16));
		lblNewLabel_2.setBounds(23, 124, 149, 20);
		contentPanel.add(lblNewLabel_2);

		txtsensorid = new JTextField();
		txtsensorid.setFont(new Font("Serif", Font.PLAIN, 15));
		...
		lblerromsg.setFont(new Font("Serif", Font.PLAIN, 13));
