...
public class SensorDetailComponent extends JPanel {
	...
	public SensorDetailComponent(String sensorId, int floorNumber, String roomNumber, boolean status, int co2level,
		...
		// set color to Red color when the smoke or CO2 level goes above level 5
		panel.setBackground(this.co2Level > 5 || this.smokeLevel > 5 ? new Color(210, 0, 0) : new Color(0,128,0));
		panel.setBounds(0, 0, 145, 174);
		add(panel);
		...
		JLabel lblNewLabel_4 = new JLabel("Floor No : ");
		...
		lblfloornumber.setFont(new Font("Serif", Font.BOLD, 20));
		...
		lblsensorstatus.setFont(new Font("Serif", Font.PLAIN, 25));
		...
		lblco2level.setFont(new Font("Serif", Font.PLAIN, 45));
		...
		lblsmokelevele.setFont(new Font("Serif", Font.PLAIN, 45));
