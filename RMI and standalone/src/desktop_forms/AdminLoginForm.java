...
public class AdminLoginForm extends JFrame {
	...
	public AdminLoginForm() {
		...
		btnsignin.setFont(new Font("Serif", Font.PLAIN, 20));
		...
		lblNewLabel_2.setFont(new Font("Serif", Font.PLAIN, 25));
